...
class Speedtest(object):
    ...
    def get_best_server(self, servers=None):
        ...
        try:
            ...
            raise SpeedtestBestServerFailure({"host_name":  socket.gethostname(),"error" : "Unable to connect to servers to test latency."})
...
def check_internet_speed():
    ...
    ISP_NAME = speedtest.config['client']
    ...
    # download = round((results.download ) , 2)
    # upload  = round((results.upload) , 2)
    ...
    OUTPUT = {
        ...
        "isp_provider" : ISP_NAME.get("isp"),
        "isp_ip" : ISP_NAME.get("ip"),
